...
public class CDijkstraMap {
     ...
     * @param level
     */
    public CDijkstraMap(final float[][] level) {
     ...
     * @param measurement
     */
    public CDijkstraMap(final float[][] level, Measurement measurement) {
     ...
     * @param level
     */
    public CDijkstraMap(final char[][] level) {
        this(level, Measurement.MANHATTAN);
    }
     ...
     * @param level
     */
    public CDijkstraMap(final char[][] level, char alternateWall) {
        path = new ObjectList<>();
     ...
     */
    public CDijkstraMap(final char[][] level, Measurement measurement) {
        path = new ObjectList<>();
        this.measurement = measurement;
     ...
     */
    public CDijkstraMap initialize(final float[][] level) {
        width = level.length;
     ...
     * @return this for chaining
     */
    public CDijkstraMap initialize(final char[][] level) {
        width = level.length;
        height = level[0].length;
        gradientMap = new float[width][height];
        physicalMap = new float[width][height];
     ...
     * @return this for chaining
     */
    public CDijkstraMap initialize(final char[][] level, char alternateWall) {
        width = level.length;
        height = level[0].length;
        gradientMap = new float[width][height];
        physicalMap = new float[width][height];
     ...
     */
    public CDijkstraMap initializeCost(final char[][] level) {
     ...
     * @return this DijkstraMap for chaining.
     */
    public CDijkstraMap initializeCost(final char[][] level, char alternateWall) {
        if (!initialized) throw new IllegalStateException("DijkstraMap must be initialized first!");
        ArrayTools.fill(costMap, 1f);
        standardCosts = true;
        return this;
     ...
     * @return this DijkstraMap for chaining.
     */
    public CDijkstraMap initializeCost(final float[][] costs) {
        if (!initialized) throw new IllegalStateException("DijkstraMap must be initialized first!");
        costMap = new float[width][height];
        for (int x = 0; x < width; x++) {
...
//    }
    ...
    private CoordSet cachedImpassable = new CoordSet(32);
