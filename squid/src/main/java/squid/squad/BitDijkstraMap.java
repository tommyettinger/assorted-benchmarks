...
public class BitDijkstraMap {
    ...
    private BitCoordSet impassable2;

    private BitCoordSet tempSet;
     ...
     * @param level
     */
    public BitDijkstraMap(final float[][] level) {
     ...
     * @param measurement
     */
    public BitDijkstraMap(final float[][] level, Measurement measurement) {
     ...
     * @param level
     */
    public BitDijkstraMap(final char[][] level) {
        this(level, Measurement.MANHATTAN);
    }
     ...
     * @param level
     */
    public BitDijkstraMap(final char[][] level, char alternateWall) {
        path = new ObjectList<>();
     ...
     */
    public BitDijkstraMap(final char[][] level, Measurement measurement) {
        path = new ObjectList<>();
        this.measurement = measurement;
     ...
     */
    public BitDijkstraMap initialize(final float[][] level) {
        width = level.length;
        ...
        standardCosts = true;
        impassable2 = new BitCoordSet(width, height);
        tempSet = new BitCoordSet(width, height);
        initialized = true;
        return this;
    }
     ...
     * @return this for chaining
     */
    public BitDijkstraMap initialize(final char[][] level) {
        width = level.length;
        height = level[0].length;
        gradientMap = new float[width][height];
        physicalMap = new float[width][height];
     ...
     * @return this for chaining
     */
    public BitDijkstraMap initialize(final char[][] level, char alternateWall) {
        width = level.length;
        height = level[0].length;
        gradientMap = new float[width][height];
        physicalMap = new float[width][height];
     ...
     */
    public BitDijkstraMap initializeCost(final char[][] level) {
     ...
     * @return this DijkstraMap for chaining.
     */
    public BitDijkstraMap initializeCost(final char[][] level, char alternateWall) {
        if (!initialized) throw new IllegalStateException("DijkstraMap must be initialized first!");
        ArrayTools.fill(costMap, 1f);
        standardCosts = true;
        return this;
     ...
     * @return this DijkstraMap for chaining.
     */
    public BitDijkstraMap initializeCost(final float[][] costs) {
        if (!initialized) throw new IllegalStateException("DijkstraMap must be initialized first!");
        costMap = new float[width][height];
        for (int x = 0; x < width; x++) {
