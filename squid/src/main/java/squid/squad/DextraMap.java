...
public class DextraMap {
     ...
     * @param level
     */
    public DextraMap(final float[][] level) {
     ...
     * @param measurement
     */
    public DextraMap(final float[][] level, Measurement measurement) {
     ...
     */
    public DextraMap(final float[][] level, Measurement measurement, boolean levelIsResistanceMap) {
     ...
     * @param level
     */
    public DextraMap(final char[][] level) {
     ...
     * @param level
     */
    public DextraMap(final char[][] level, char alternateWall) {
        path = new ObjectDeque<>();
     ...
     */
    public DextraMap(final char[][] level, Measurement measurement) {
        path = new ObjectDeque<>();
        this.measurement = measurement;
     ...
     */
    public DextraMap initialize(final float[][] level) {
     ...
     * @return this for chaining
     */
    public DextraMap initialize(final char[][] level) {
        int oldWidth = width, oldHeight = height;
        width = level.length;
        height = level[0].length;
        if (width != oldWidth || height != oldHeight) {
     ...
     * @return this for chaining
     */
    public DextraMap initialize(final char[][] level, char alternateWall) {
        int oldWidth = width, oldHeight = height;
        width = level.length;
        height = level[0].length;
        if (width != oldWidth || height != oldHeight) {
     ...
     * @return this for chaining
     */
    public DextraMap initializeByResistance(final float[][] level) {
        int oldWidth = width, oldHeight = height;
        width = level.length;
        height = level[0].length;
        if (width != oldWidth || height != oldHeight) {
     ...
     */
    public DextraMap initializeCost(final char[][] level) {
     ...
     * @return this DijkstraMap for chaining.
     */
    public DextraMap initializeCost(final char[][] level, char alternateWall) {
        if (!initialized) throw new IllegalStateException("DijkstraMap must be initialized first!");
        ArrayTools.fill(costMap, 1f);
        standardCosts = true;
        return this;
     ...
     * @return this DijkstraMap for chaining.
     */
    public DextraMap initializeCost(final float[][] costs) {
        if (!initialized) throw new IllegalStateException("DijkstraMap must be initialized first!");
        costMap = new float[width][height];
        for (int x = 0; x < width; x++) {
