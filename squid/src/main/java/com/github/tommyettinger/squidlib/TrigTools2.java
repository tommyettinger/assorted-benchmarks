...
public final class TrigTools2 {
    ...
    /**
     * If you add this to an index used in {@link #COS_TABLE}, you get the result of the cosine instead of the sine.
     */
...
//        return x * ((1.0/945.0) * x4 - (1.0/9.0) * x2 + 1.0) / ((1.0/63.0) * x4 - (4.0/9.0) * x2 + 1.0);
    ...
    public static float sinDeg(float degrees) {
        ...
        return COS_TABLE[(int) (degrees * degToIndex + 0.5f) & TABLE_MASK];
    }
    ...
    public static float cosDeg(float degrees) {
        return COS_TABLE[(int) (degrees * degToIndex + 0.5f) + SIN_TO_COS & TABLE_MASK];
    }
    ...
    public static float sinTurns(float turns) {
        return COS_TABLE[(int) (turns * turnToIndex + 0.5f) & TABLE_MASK];
    }
    ...
    public static float cosTurns(float turns) {
        return COS_TABLE[(int) (turns * turnToIndex + 0.5f) + SIN_TO_COS & TABLE_MASK];
    }
    ...
    public static double sin(double radians) {
        return COS_TABLE_D[(int) (radians * radToIndexD + 0.5) & TABLE_MASK];
    }
    ...
    public static double cos(double radians) {
        return COS_TABLE_D[(int) (radians * radToIndexD + 0.5) + SIN_TO_COS & TABLE_MASK];
    }
...
//        return x * ((1.0/945.0) * x4 - (1.0/9.0) * x2 + 1.0) / ((1.0/63.0) * x4 - (4.0/9.0) * x2 + 1.0);
    ...
    public static double sinDeg(double degrees) {
        return COS_TABLE_D[(int) (degrees * degToIndexD + 0.5) & TABLE_MASK];
    }
    ...
    public static double cosDeg(double degrees) {
        return COS_TABLE_D[(int) (degrees * degToIndexD + 0.5) + SIN_TO_COS & TABLE_MASK];
    }
    ...
    public static double sinTurns(double turns) {
        return COS_TABLE_D[(int) (turns * turnToIndexD + 0.5) & TABLE_MASK];
    }
    ...
    public static double cosTurns(double turns) {
        return COS_TABLE_D[(int) (turns * turnToIndexD + 0.5) + SIN_TO_COS & TABLE_MASK];
    }
