...
public class LineWobble {
    ...
    public static double wobble(long seed, double value)
    {
        ...
        final double start = (((z = (z ^ z >>> 31) * 0xF1357AEA2E62A9C5L) ^ z >>> 29) * 0xF1357AEA2E62A9C5L) * 0x0.fffffffffffffbp-63,
                end = (((z = ((z = seed + 0x6C8E9CF570932BD5L) ^ z >>> 31) * 0xF1357AEA2E62A9C5L) ^ z >>> 29) * 0xF1357AEA2E62A9C5L) * 0x0.fffffffffffffbp-63;
    ...
    public static float wobble(long seed, float value)
    {
        ...
        long z = (seed += floor * 0x6C8E9CF570932BD5L);
        final float start = (((z = (z ^ z >>> 31) * 0xF1357AEA2E62A9C5L) ^ z >>> 29) * 0xF1357AEA2E62A9C5L) * 0x0.ffffffp-63f,
                end = (((z = ((z = seed + 0x6C8E9CF570932BD5L) ^ z >>> 31) * 0xF1357AEA2E62A9C5L) ^ z >>> 29) * 0xF1357AEA2E62A9C5L) * 0x0.ffffffp-63f;
        value -= floor;
    ...
    public static float wobble(final int seed, float value)
    {
        ...
        int z = seed + floor;
        final float start = ((z = ((z = (z ^ 0xD1B54A35) * 0x1D2BC3) ^ z >>> 16 ^ 0xD1B54A35) * 0x1D2BC3) ^ z >>> 15 ^ 0xD1B54A35) * 0x1D2BC3 * 0x0.ffffffp-31f,
                end = ((z = ((z = (seed + floor + 1 ^ 0xD1B54A35) * 0x1D2BC3) ^ z >>> 16 ^ 0xD1B54A35) * 0x1D2BC3) ^ z >>> 15 ^ 0xD1B54A35) * 0x1D2BC3 * 0x0.ffffffp-31f;
        value -= floor;
     ...
     * @return a pseudo-random float between 0f and 6.283185307179586f (both inclusive), smoothly changing with value and wrapping
     */
    public static float wiggleAngle(long seed, float value)
    {
        final long floor = value >= 0f ? (long) value : (long) value - 1L;
        final long z = seed + floor * 0x6C8E9CF570932BD5L;
     ...
     * @return a pseudo-random float between 0f and 360.0f (both inclusive), smoothly changing with value and wrapping
     */
    public static float wiggleAngleDeg(long seed, float value)
    {
        final long floor = value >= 0f ? (long) value : (long) value - 1L;
        final long z = seed + floor * 0x6C8E9CF570932BD5L;
        float start = (((z ^ 0x9E3779B97F4A7C15L) * 0xC6BC279692B5C323L ^ 0x9E3779B97F4A7C15L) >>> 1) * 0x0.ffffffp-62f,
     ...
     * @return a pseudo-random float between 0.0f and 1.0f (both inclusive), smoothly changing with value and wrapping
     */
    public static float wiggleAngleTurns(long seed, float value)
    {
        final long floor = value >= 0f ? (long) value : (long) value - 1L;
        final long z = seed + floor * 0x6C8E9CF570932BD5L;
        float start = (((z ^ 0x9E3779B97F4A7C15L) * 0xC6BC279692B5C323L ^ 0x9E3779B97F4A7C15L) >>> 1) * 0x0.ffffffp-62f,
     ...
     * @return a pseudo-random float between 0f and 6.283185307179586f (both inclusive), smoothly changing with value and wrapping
     */
    public static float wiggleAngle(int seed, float value)
    {
        final int floor = value >= 0f ? (int) value : (int) value - 1;
        int z = seed + floor * 0xBE56D;
     ...
     * @return a pseudo-random float between 0f and 360.0f (both inclusive), smoothly changing with value and wrapping
     */
    public static float wiggleAngleDeg(int seed, float value)
    {
        final int floor = value >= 0f ? (int) value : (int) value - 1;
        int z = seed + floor * 0xBE56D;
        float start = (((z ^ 0xD1B54A35) * 0x1D2BC3 ^ 0xD1B54A35) >>> 1) * 0x0.ffffffp-30f,
     ...
     * @return a pseudo-random float between 0.0f and 1.0f (both inclusive), smoothly changing with value and wrapping
     */
    public static float wiggleAngleTurns(int seed, float value)
    {
        final int floor = value >= 0f ? (int) value : (int) value - 1;
        int z = seed + floor * 0xBE56D;
        float start = (((z ^ 0xD1B54A35) * 0x1D2BC3 ^ 0xD1B54A35) >>> 1) * 0x0.ffffffp-30f,
