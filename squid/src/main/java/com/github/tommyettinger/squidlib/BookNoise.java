 ...
 */
public class BookNoise {

    private final Vector2 v = new Vector2();
    private final Vector2 i = new Vector2();
    private final Vector2 i1 = new Vector2();
    private final Vector2 x0 = new Vector2();
    private final Vector2 x1 = new Vector2();
    private final Vector2 x2 = new Vector2();
    ...
    private final Vector3 ox = new Vector3();
    private final Vector3 a0 = new Vector3();
    private final Vector3 g = new Vector3();
    private static final float C0 =  0.211324865405187f;
    private static final float C1 =  0.366025403784439f;
    private static final float C2 = -0.577350269189626f;
    private static final float C3 =  0.024390243902439f;
    ...
    public float query(float x, float y, float frequency) {
        ...
        x1.set(x0.x + C0 - i1.x, x0.y + C0 - i1.y);
        x2.set(x0.x + C2, x0.y + C2);
