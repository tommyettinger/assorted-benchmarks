...
import static com.github.tommyettinger.squidlib.CrossHash.Water.b2;
import static com.github.tommyettinger.squidlib.CrossHash.Water.b3;
import static com.github.tommyettinger.squidlib.CrossHash.Water.b4;
import static com.github.tommyettinger.squidlib.CrossHash.Water.b5;
...
//                    c = (seed << 31 | seed >>> 33) ^ b2, d = (seed << 47 | seed >>> 17) ^ b1;
    ...
    public static final class Yolk {
        ...
        public long hash64(final ByteBuffer data, int start, int length) {
            ...
            data.position(start);
            long seed = this.seed, a = seed + b4, b = seed + b3, c = seed + b2, d = seed + b1;
            for (int i = 31; i < len; i+=32) {
            ...
            switch (len & 31) {
                ...
                case	1:	seed = wow(seed, (data.get()) ^ b1);	break;
                case	2:	seed = wow(seed, (data.getShort()) ^ b1);	break;
                case	3:	seed = wow(seed, (((long)data.getShort() << 8) ^ (data.get())) ^ b1);	break;
                case	4:	seed = wow(seed, (data.getInt()) ^ b1);	break;
                case	5:	seed = wow(seed, (((long)data.getInt() << 8)  ^ (data.get())) ^ b1);	break;
                case	6:	seed = wow(seed, (((long)data.getInt() << 16) ^ (data.getShort())) ^ b1);	break;
                case	7:	seed = wow(seed, (((long)data.getInt() << 24) ^ ((long)data.getShort() << 8) ^ (data.get())) ^ b1);	break;
                case	8:	seed = wow(seed, data.getLong() ^ b1);	break;
                case	9:	seed = wow(data.getLong() + seed, (data.get()) ^ b2);	break;
                case	10:	seed = wow(data.getLong() + seed, (data.getShort()) ^ b2);	break;
                case	11:	seed = wow(data.getLong() + seed, (((long)data.getShort() << 8) ^ (data.get())) ^ b2);	break;
                case	12:	seed = wow(data.getLong() + seed, (data.getInt()) ^ b2);	break;
                case	13:	seed = wow(data.getLong() + seed, (((long)data.getInt() << 8)  ^ (data.get())) ^ b2);	break;
                case	14:	seed = wow(data.getLong() + seed, (((long)data.getInt() << 16) ^ (data.getShort())) ^ b2);	break;
                case	15:	seed = wow(data.getLong() + seed, (((long)data.getInt() << 24) ^ ((long)data.getShort() << 8) ^ (data.get())) ^ b2);	break;
                case	16:	seed = wow(data.getLong() + seed, data.getLong() + b2);	break;
                case	17:	seed = wow(data.getLong() + seed, (data.getInt()) + b2) + wow((data.getInt()) ^ seed, (data.get()) ^ b3);	break;
                case	18:	seed = wow(data.getLong() + seed, (data.getInt()) + b2) + wow((data.getInt()) ^ seed, (data.getShort()) ^ b3);	break;
                case	19:	seed = wow(data.getLong() + seed, (data.getInt()) + b2) + wow((data.getInt()) ^ seed, (((long)data.getShort() << 8) ^ (data.get())) ^ b3);	break;
                case	20:	seed = wow(data.getLong() + seed, (data.getInt()) + b2) + wow((data.getInt()) ^ seed, (data.getInt()) ^ b3);	break;
                case	21:	seed = wow(data.getLong() + seed, data.getLong() + b2) + wow((data.getShort()) ^ seed, (((long)data.getShort() << 8) ^ (data.get())) ^ b3);	break;
                case	22:	seed = wow(data.getLong() + seed, data.getLong() + b2) + wow((data.getShort()) ^ seed, ((long)data.getInt() << 16) ^ b3);	break;
                case	23:	seed = wow(data.getLong() + seed, data.getLong() + b2) + wow(b4 + seed, (((long)data.getInt() << 24) ^ ((long)data.getShort() << 8) ^ (data.get())) ^ b3);	break;
                case	24:	seed = wow(data.getLong() + seed, data.getLong() + b2) + wow(data.getLong() + seed, seed ^ b3);	break;
                case	25:	seed = wow(data.getLong() + seed, data.getLong() + b2) + wow(data.getLong() ^ seed, (data.get()) ^ b4);	break;
                case	26:	seed = wow(data.getLong() + seed, data.getLong() + b2) + wow(data.getLong() ^ seed, (data.getShort()) ^ b4);	break;
                case	27:	seed = wow(data.getLong() + seed, data.getLong() + b2) + wow(data.getLong() ^ seed, (((long)data.getShort() << 8) ^ (data.get())) ^ b4);	break;
                case	28:	seed = wow(data.getLong() + seed, data.getLong() + b2) + wow(data.getLong() ^ seed, (data.getInt()) ^ b4);	break;
                case	29:	seed = wow(data.getLong() + seed, data.getLong() + b2) + wow(data.getLong() ^ seed, (((long)data.getInt() << 8) ^ (data.get())) ^ b4);	break;
                case	30:	seed = wow(data.getLong() + seed, data.getLong() + b2) + wow(data.getLong() ^ seed, (((long)data.getInt() << 16) ^ (data.getShort())) ^ b4);	break;
                case	31:	seed = wow(data.getLong() + seed, data.getLong() + b2) + wow(data.getLong() ^ seed, (((long)data.getInt() << 24) ^ ((long)data.getShort() << 8) ^ (data.get())) ^ b4);	break;
            }
    ...
    public static final class Curlup {
        ...
        public long hash64(final Iterable<? extends CharSequence> data) {
            ...
            while (it.hasNext())
            {
                ++len;
                seed = Water.mum(
                        Water.mum(hash(it.next()) ^ b1, (it.hasNext() ? hash(it.next()) ^ b2 ^ ++len : b2)) + seed,
                        Water.mum((it.hasNext() ? hash(it.next()) ^ b3 ^ ++len : b3), (it.hasNext() ? hash(it.next()) ^ b4 ^ ++len : b4)));
            }
            seed = (seed ^ seed << 16) * (len ^ b0);
            return seed - (seed >>> 31) + (seed << 33);
        }
        ...
        public int hash(final Iterable<? extends CharSequence> data) {
            ...
            return (int) Water.mum(seed ^ seed << 16, len ^ b0);
        }
        ...
        public static long hash64(final long seed, final Iterable<? extends CharSequence> data) {
            ...
            while (it.hasNext())
            {
                ++len;
                s = Water.mum(
                        Water.mum(hash(seed, it.next()) ^ b1, (it.hasNext() ? hash(seed, it.next()) ^ b2 ^ ++len : b2)) + s,
                        Water.mum((it.hasNext() ? hash(seed, it.next()) ^ b3 ^ ++len : b3), (it.hasNext() ? hash(seed, it.next()) ^ b4 ^ ++len : b4)));
            }
            s = (s ^ s << 16) * (len ^ b0);
            return s - (s >>> 31) + (s << 33);
        }
        ...
        public static int hash(final long seed, final Iterable<? extends CharSequence> data) {
            ...
            return (int) Water.mum(s ^ s << 16, len ^ b0);
        }
    ...
    public static final class Mx {
        ...
        public int hash(final Object data) {
            if (data == null) return 0;
            return (int)mixStream(seed, data.hashCode() * C);
        }
     ...
     * are 64 numbers outside that range so you can choose any of those when a functor must be different.
     */
    public static final class Hound {
         ...
         * This is very similar to wyhash's mum function, but doesn't use 128-bit math because it expects that its
         * arguments are only relevant in their lower 32 bits (allowing their product to fit in 64 bits).
         * @param x a long that should probably only hold an int's worth of data
         * @param y a long that should probably only hold an int's worth of data
         * @return a sort-of randomized output dependent on both inputs
         */
        @SuppressWarnings("SuspiciousNameCombination")
        public static long mum(long x, long y) {
            x += y;
            return y + ((x) * (x+1) >> 1);
        }
         ...
         */
        @SuppressWarnings("SuspiciousNameCombination")
        public static long wow(long x, final long y) {
            x += y;
            return y + ((x) * (x+1) >> 1);
        }
        ...
        public Hound(long seed)
        {
            seed += b1;
            this.seed = seed ^ seed >>> 23 ^ seed >>> 48 ^ seed << 7 ^ seed << 53;
        }
        public Hound(final CharSequence seed)
        {
            this(seed == null ? 0L : Hound.hash(seed.hashCode() ^ b2, seed) ^ b3);
        }

        public static final Hound alpha = new Hound("alpha"), beta = new Hound("beta"), gamma = new Hound("gamma"),
                delta = new Hound("delta"), epsilon = new Hound("epsilon"), zeta = new Hound("zeta"),
                eta = new Hound("eta"), theta = new Hound("theta"), iota = new Hound("iota"),
                kappa = new Hound("kappa"), lambda = new Hound("lambda"), mu = new Hound("mu"),
                nu = new Hound("nu"), xi = new Hound("xi"), omicron = new Hound("omicron"), pi = new Hound("pi"),
                rho = new Hound("rho"), sigma = new Hound("sigma"), tau = new Hound("tau"),
                upsilon = new Hound("upsilon"), phi = new Hound("phi"), chi = new Hound("chi"), psi = new Hound("psi"),
                omega = new Hound("omega"),
                alpha_ = new Hound("ALPHA"), beta_ = new Hound("BETA"), gamma_ = new Hound("GAMMA"),
                delta_ = new Hound("DELTA"), epsilon_ = new Hound("EPSILON"), zeta_ = new Hound("ZETA"),
                eta_ = new Hound("ETA"), theta_ = new Hound("THETA"), iota_ = new Hound("IOTA"),
                kappa_ = new Hound("KAPPA"), lambda_ = new Hound("LAMBDA"), mu_ = new Hound("MU"),
                nu_ = new Hound("NU"), xi_ = new Hound("XI"), omicron_ = new Hound("OMICRON"), pi_ = new Hound("PI"),
                rho_ = new Hound("RHO"), sigma_ = new Hound("SIGMA"), tau_ = new Hound("TAU"),
                upsilon_ = new Hound("UPSILON"), phi_ = new Hound("PHI"), chi_ = new Hound("CHI"), psi_ = new Hound("PSI"),
                omega_ = new Hound("OMEGA"),
                baal = new Hound("baal"), agares = new Hound("agares"), vassago = new Hound("vassago"), samigina = new Hound("samigina"),
                marbas = new Hound("marbas"), valefor = new Hound("valefor"), amon = new Hound("amon"), barbatos = new Hound("barbatos"),
                paimon = new Hound("paimon"), buer = new Hound("buer"), gusion = new Hound("gusion"), sitri = new Hound("sitri"),
                beleth = new Hound("beleth"), leraje = new Hound("leraje"), eligos = new Hound("eligos"), zepar = new Hound("zepar"),
                botis = new Hound("botis"), bathin = new Hound("bathin"), sallos = new Hound("sallos"), purson = new Hound("purson"),
                marax = new Hound("marax"), ipos = new Hound("ipos"), aim = new Hound("aim"), naberius = new Hound("naberius"),
                glasya_labolas = new Hound("glasya_labolas"), bune = new Hound("bune"), ronove = new Hound("ronove"), berith = new Hound("berith"),
                astaroth = new Hound("astaroth"), forneus = new Hound("forneus"), foras = new Hound("foras"), asmoday = new Hound("asmoday"),
                gaap = new Hound("gaap"), furfur = new Hound("furfur"), marchosias = new Hound("marchosias"), stolas = new Hound("stolas"),
                phenex = new Hound("phenex"), halphas = new Hound("halphas"), malphas = new Hound("malphas"), raum = new Hound("raum"),
                focalor = new Hound("focalor"), vepar = new Hound("vepar"), sabnock = new Hound("sabnock"), shax = new Hound("shax"),
                vine = new Hound("vine"), bifrons = new Hound("bifrons"), vual = new Hound("vual"), haagenti = new Hound("haagenti"),
                crocell = new Hound("crocell"), furcas = new Hound("furcas"), balam = new Hound("balam"), alloces = new Hound("alloces"),
                caim = new Hound("caim"), murmur = new Hound("murmur"), orobas = new Hound("orobas"), gremory = new Hound("gremory"),
                ose = new Hound("ose"), amy = new Hound("amy"), orias = new Hound("orias"), vapula = new Hound("vapula"),
                zagan = new Hound("zagan"), valac = new Hound("valac"), andras = new Hound("andras"), flauros = new Hound("flauros"),
                andrealphus = new Hound("andrealphus"), kimaris = new Hound("kimaris"), amdusias = new Hound("amdusias"), belial = new Hound("belial"),
                decarabia = new Hound("decarabia"), seere = new Hound("seere"), dantalion = new Hound("dantalion"), andromalius = new Hound("andromalius"),
                baal_ = new Hound("BAAL"), agares_ = new Hound("AGARES"), vassago_ = new Hound("VASSAGO"), samigina_ = new Hound("SAMIGINA"),
                marbas_ = new Hound("MARBAS"), valefor_ = new Hound("VALEFOR"), amon_ = new Hound("AMON"), barbatos_ = new Hound("BARBATOS"),
                paimon_ = new Hound("PAIMON"), buer_ = new Hound("BUER"), gusion_ = new Hound("GUSION"), sitri_ = new Hound("SITRI"),
                beleth_ = new Hound("BELETH"), leraje_ = new Hound("LERAJE"), eligos_ = new Hound("ELIGOS"), zepar_ = new Hound("ZEPAR"),
                botis_ = new Hound("BOTIS"), bathin_ = new Hound("BATHIN"), sallos_ = new Hound("SALLOS"), purson_ = new Hound("PURSON"),
                marax_ = new Hound("MARAX"), ipos_ = new Hound("IPOS"), aim_ = new Hound("AIM"), naberius_ = new Hound("NABERIUS"),
                glasya_labolas_ = new Hound("GLASYA_LABOLAS"), bune_ = new Hound("BUNE"), ronove_ = new Hound("RONOVE"), berith_ = new Hound("BERITH"),
                astaroth_ = new Hound("ASTAROTH"), forneus_ = new Hound("FORNEUS"), foras_ = new Hound("FORAS"), asmoday_ = new Hound("ASMODAY"),
                gaap_ = new Hound("GAAP"), furfur_ = new Hound("FURFUR"), marchosias_ = new Hound("MARCHOSIAS"), stolas_ = new Hound("STOLAS"),
                phenex_ = new Hound("PHENEX"), halphas_ = new Hound("HALPHAS"), malphas_ = new Hound("MALPHAS"), raum_ = new Hound("RAUM"),
                focalor_ = new Hound("FOCALOR"), vepar_ = new Hound("VEPAR"), sabnock_ = new Hound("SABNOCK"), shax_ = new Hound("SHAX"),
                vine_ = new Hound("VINE"), bifrons_ = new Hound("BIFRONS"), vual_ = new Hound("VUAL"), haagenti_ = new Hound("HAAGENTI"),
                crocell_ = new Hound("CROCELL"), furcas_ = new Hound("FURCAS"), balam_ = new Hound("BALAM"), alloces_ = new Hound("ALLOCES"),
                caim_ = new Hound("CAIM"), murmur_ = new Hound("MURMUR"), orobas_ = new Hound("OROBAS"), gremory_ = new Hound("GREMORY"),
                ose_ = new Hound("OSE"), amy_ = new Hound("AMY"), orias_ = new Hound("ORIAS"), vapula_ = new Hound("VAPULA"),
                zagan_ = new Hound("ZAGAN"), valac_ = new Hound("VALAC"), andras_ = new Hound("ANDRAS"), flauros_ = new Hound("FLAUROS"),
                andrealphus_ = new Hound("ANDREALPHUS"), kimaris_ = new Hound("KIMARIS"), amdusias_ = new Hound("AMDUSIAS"), belial_ = new Hound("BELIAL"),
                decarabia_ = new Hound("DECARABIA"), seere_ = new Hound("SEERE"), dantalion_ = new Hound("DANTALION"), andromalius_ = new Hound("ANDROMALIUS")
                ;
        /**
         * Has a length of 192, which may be relevant if automatically choosing a predefined hash functor.
         */
        public static final Hound[] predefined = new Hound[]{alpha, beta, gamma, delta, epsilon, zeta, eta, theta, iota,
                kappa, lambda, mu, nu, xi, omicron, pi, rho, sigma, tau, upsilon, phi, chi, psi, omega,
                alpha_, beta_, gamma_, delta_, epsilon_, zeta_, eta_, theta_, iota_,
                kappa_, lambda_, mu_, nu_, xi_, omicron_, pi_, rho_, sigma_, tau_, upsilon_, phi_, chi_, psi_, omega_,
                baal, agares, vassago, samigina, marbas, valefor, amon, barbatos,
    ...
    public static final class Tempo {
        ...
        public Tempo(long seed)
        {
            this.seed = seed;
        }

        public Tempo(final CharSequence seed)
        {
            this(hash64(seed.hashCode(), seed));
        }

        public static final Tempo alpha = new Tempo("alpha"), beta = new Tempo("beta"), gamma = new Tempo("gamma"),
                delta = new Tempo("delta"), epsilon = new Tempo("epsilon"), zeta = new Tempo("zeta"),
                eta = new Tempo("eta"), theta = new Tempo("theta"), iota = new Tempo("iota"),
                kappa = new Tempo("kappa"), lambda = new Tempo("lambda"), mu = new Tempo("mu"),
                nu = new Tempo("nu"), xi = new Tempo("xi"), omicron = new Tempo("omicron"), pi = new Tempo("pi"),
                rho = new Tempo("rho"), sigma = new Tempo("sigma"), tau = new Tempo("tau"),
                upsilon = new Tempo("upsilon"), phi = new Tempo("phi"), chi = new Tempo("chi"), psi = new Tempo("psi"),
                omega = new Tempo("omega"),
                alpha_ = new Tempo("ALPHA"), beta_ = new Tempo("BETA"), gamma_ = new Tempo("GAMMA"),
                delta_ = new Tempo("DELTA"), epsilon_ = new Tempo("EPSILON"), zeta_ = new Tempo("ZETA"),
                eta_ = new Tempo("ETA"), theta_ = new Tempo("THETA"), iota_ = new Tempo("IOTA"),
                kappa_ = new Tempo("KAPPA"), lambda_ = new Tempo("LAMBDA"), mu_ = new Tempo("MU"),
                nu_ = new Tempo("NU"), xi_ = new Tempo("XI"), omicron_ = new Tempo("OMICRON"), pi_ = new Tempo("PI"),
                rho_ = new Tempo("RHO"), sigma_ = new Tempo("SIGMA"), tau_ = new Tempo("TAU"),
                upsilon_ = new Tempo("UPSILON"), phi_ = new Tempo("PHI"), chi_ = new Tempo("CHI"), psi_ = new Tempo("PSI"),
                omega_ = new Tempo("OMEGA"),
                baal = new Tempo("baal"), agares = new Tempo("agares"), vassago = new Tempo("vassago"), samigina = new Tempo("samigina"),
                marbas = new Tempo("marbas"), valefor = new Tempo("valefor"), amon = new Tempo("amon"), barbatos = new Tempo("barbatos"),
                paimon = new Tempo("paimon"), buer = new Tempo("buer"), gusion = new Tempo("gusion"), sitri = new Tempo("sitri"),
                beleth = new Tempo("beleth"), leraje = new Tempo("leraje"), eligos = new Tempo("eligos"), zepar = new Tempo("zepar"),
                botis = new Tempo("botis"), bathin = new Tempo("bathin"), sallos = new Tempo("sallos"), purson = new Tempo("purson"),
                marax = new Tempo("marax"), ipos = new Tempo("ipos"), aim = new Tempo("aim"), naberius = new Tempo("naberius"),
                glasya_labolas = new Tempo("glasya_labolas"), bune = new Tempo("bune"), ronove = new Tempo("ronove"), berith = new Tempo("berith"),
                astaroth = new Tempo("astaroth"), forneus = new Tempo("forneus"), foras = new Tempo("foras"), asmoday = new Tempo("asmoday"),
                gaap = new Tempo("gaap"), furfur = new Tempo("furfur"), marchosias = new Tempo("marchosias"), stolas = new Tempo("stolas"),
                phenex = new Tempo("phenex"), halphas = new Tempo("halphas"), malphas = new Tempo("malphas"), raum = new Tempo("raum"),
                focalor = new Tempo("focalor"), vepar = new Tempo("vepar"), sabnock = new Tempo("sabnock"), shax = new Tempo("shax"),
                vine = new Tempo("vine"), bifrons = new Tempo("bifrons"), vual = new Tempo("vual"), haagenti = new Tempo("haagenti"),
                crocell = new Tempo("crocell"), furcas = new Tempo("furcas"), balam = new Tempo("balam"), alloces = new Tempo("alloces"),
                caim = new Tempo("caim"), murmur = new Tempo("murmur"), orobas = new Tempo("orobas"), gremory = new Tempo("gremory"),
                ose = new Tempo("ose"), amy = new Tempo("amy"), orias = new Tempo("orias"), vapula = new Tempo("vapula"),
                zagan = new Tempo("zagan"), valac = new Tempo("valac"), andras = new Tempo("andras"), flauros = new Tempo("flauros"),
                andrealphus = new Tempo("andrealphus"), kimaris = new Tempo("kimaris"), amdusias = new Tempo("amdusias"), belial = new Tempo("belial"),
                decarabia = new Tempo("decarabia"), seere = new Tempo("seere"), dantalion = new Tempo("dantalion"), andromalius = new Tempo("andromalius"),
                baal_ = new Tempo("BAAL"), agares_ = new Tempo("AGARES"), vassago_ = new Tempo("VASSAGO"), samigina_ = new Tempo("SAMIGINA"),
                marbas_ = new Tempo("MARBAS"), valefor_ = new Tempo("VALEFOR"), amon_ = new Tempo("AMON"), barbatos_ = new Tempo("BARBATOS"),
                paimon_ = new Tempo("PAIMON"), buer_ = new Tempo("BUER"), gusion_ = new Tempo("GUSION"), sitri_ = new Tempo("SITRI"),
                beleth_ = new Tempo("BELETH"), leraje_ = new Tempo("LERAJE"), eligos_ = new Tempo("ELIGOS"), zepar_ = new Tempo("ZEPAR"),
                botis_ = new Tempo("BOTIS"), bathin_ = new Tempo("BATHIN"), sallos_ = new Tempo("SALLOS"), purson_ = new Tempo("PURSON"),
                marax_ = new Tempo("MARAX"), ipos_ = new Tempo("IPOS"), aim_ = new Tempo("AIM"), naberius_ = new Tempo("NABERIUS"),
                glasya_labolas_ = new Tempo("GLASYA_LABOLAS"), bune_ = new Tempo("BUNE"), ronove_ = new Tempo("RONOVE"), berith_ = new Tempo("BERITH"),
                astaroth_ = new Tempo("ASTAROTH"), forneus_ = new Tempo("FORNEUS"), foras_ = new Tempo("FORAS"), asmoday_ = new Tempo("ASMODAY"),
                gaap_ = new Tempo("GAAP"), furfur_ = new Tempo("FURFUR"), marchosias_ = new Tempo("MARCHOSIAS"), stolas_ = new Tempo("STOLAS"),
                phenex_ = new Tempo("PHENEX"), halphas_ = new Tempo("HALPHAS"), malphas_ = new Tempo("MALPHAS"), raum_ = new Tempo("RAUM"),
                focalor_ = new Tempo("FOCALOR"), vepar_ = new Tempo("VEPAR"), sabnock_ = new Tempo("SABNOCK"), shax_ = new Tempo("SHAX"),
                vine_ = new Tempo("VINE"), bifrons_ = new Tempo("BIFRONS"), vual_ = new Tempo("VUAL"), haagenti_ = new Tempo("HAAGENTI"),
                crocell_ = new Tempo("CROCELL"), furcas_ = new Tempo("FURCAS"), balam_ = new Tempo("BALAM"), alloces_ = new Tempo("ALLOCES"),
                caim_ = new Tempo("CAIM"), murmur_ = new Tempo("MURMUR"), orobas_ = new Tempo("OROBAS"), gremory_ = new Tempo("GREMORY"),
                ose_ = new Tempo("OSE"), amy_ = new Tempo("AMY"), orias_ = new Tempo("ORIAS"), vapula_ = new Tempo("VAPULA"),
                zagan_ = new Tempo("ZAGAN"), valac_ = new Tempo("VALAC"), andras_ = new Tempo("ANDRAS"), flauros_ = new Tempo("FLAUROS"),
                andrealphus_ = new Tempo("ANDREALPHUS"), kimaris_ = new Tempo("KIMARIS"), amdusias_ = new Tempo("AMDUSIAS"), belial_ = new Tempo("BELIAL"),
                decarabia_ = new Tempo("DECARABIA"), seere_ = new Tempo("SEERE"), dantalion_ = new Tempo("DANTALION"), andromalius_ = new Tempo("ANDROMALIUS")
                ;
        /**
         * Has a length of 192, which may be relevant if automatically choosing a predefined hash functor.
         */
        public static final Tempo[] predefined = new Tempo[]{alpha, beta, gamma, delta, epsilon, zeta, eta, theta, iota,
                kappa, lambda, mu, nu, xi, omicron, pi, rho, sigma, tau, upsilon, phi, chi, psi, omega,
                alpha_, beta_, gamma_, delta_, epsilon_, zeta_, eta_, theta_, iota_,
                kappa_, lambda_, mu_, nu_, xi_, omicron_, pi_, rho_, sigma_, tau_, upsilon_, phi_, chi_, psi_, omega_,
                baal, agares, vassago, samigina, marbas, valefor, amon, barbatos,
        ...
        public long hash64(final char[] data) {
            if (data == null) return 0;
            int i = 0, len = data.length, stricter = len - 15;
            long a = seed ^ len, b = a + 0xF7C2EBC08F67F2B5L, c = ~a + 0x94D049BB133111EBL, d = ~b + 0x8538ECB5BD456EA3L;
            long m = 0xDB4F0B9175AE2165L ^ a;
            ...
            long gd = a;
            switch(len & 15) {
                case 0xF: gd ^= (long)data[i + 0xE] << 32;
                case 0xE: gd ^= (long)data[i + 0xD] << 16;
                case 0xD: gd ^=       data[i + 0xC];
                case 0xC: gc ^= (long)data[i + 0xB] << 48;
                case 0xB: gc ^= (long)data[i + 0xA] << 32;
                case 0xA: gc ^= (long)data[i + 0x9] << 16;
                case 0x9: gc ^=       data[i + 0x8];
                case 0x8: gb ^= (long)data[i + 0x7] << 48;
                case 0x7: gb ^= (long)data[i + 0x6] << 32;
                case 0x6: gb ^= (long)data[i + 0x5] << 16;
                case 0x5: gb ^=       data[i + 0x4];
                case 0x4: ga ^= (long)data[i + 0x3] << 48;
                case 0x3: ga ^= (long)data[i + 0x2] << 32;
                case 0x2: ga ^= (long)data[i + 0x1] << 16;
                case 0x1: ga ^=       data[i      ];
                    a += (ga << 25 | ga >>> 39);
                    b += (gb << 44 | gb >>> 20);
                    c += (gc << 37 | gc >>> 27);
        ...
        public long hash64(final CharSequence data) {
            ...
            long gd = a;
            switch(len & 15) {
                case 0xF: gd ^= (long)data.charAt(i + 0xE) << 32;
                case 0xE: gd ^= (long)data.charAt(i + 0xD) << 16;
                case 0xD: gd ^=       data.charAt(i + 0xC);
                case 0xC: gc ^= (long)data.charAt(i + 0xB) << 48;
                case 0xB: gc ^= (long)data.charAt(i + 0xA) << 32;
                case 0xA: gc ^= (long)data.charAt(i + 0x9) << 16;
                case 0x9: gc ^=       data.charAt(i + 0x8);
                case 0x8: gb ^= (long)data.charAt(i + 0x7) << 48;
                case 0x7: gb ^= (long)data.charAt(i + 0x6) << 32;
                case 0x6: gb ^= (long)data.charAt(i + 0x5) << 16;
                case 0x5: gb ^=       data.charAt(i + 0x4);
                case 0x4: ga ^= (long)data.charAt(i + 0x3) << 48;
                case 0x3: ga ^= (long)data.charAt(i + 0x2) << 32;
                case 0x2: ga ^= (long)data.charAt(i + 0x1) << 16;
                case 0x1: ga ^=       data.charAt(i      );
                    a += (ga << 25 | ga >>> 39);
                    b += (gb << 44 | gb >>> 20);
                    c += (gc << 37 | gc >>> 27);
                    d += (gd << 18 | gd >>> 46);
        ...
        public long hash64(final int[] data) {
            if (data == null) return 0;
            int i = 0, len = data.length, stricter = len - 7;
            long a = seed ^ len, b = a + 0xF7C2EBC08F67F2B5L, c = ~a + 0x94D049BB133111EBL, d = ~b + 0x8538ECB5BD456EA3L;
            long m = 0xDB4F0B9175AE2165L ^ a;
            ...
            long gd = a;
            switch(len & 7) {
                case 0x7: gd ^=       data[i + 0x6];
                case 0x6: gc ^= (long)data[i + 0x5] << 32;
                case 0x5: gc ^=       data[i + 0x4];
                case 0x4: gb ^= (long)data[i + 0x3] << 32;
                case 0x3: gb ^=       data[i + 0x2];
                case 0x2: ga ^= (long)data[i + 0x1] << 32;
                case 0x1: ga ^=       data[i      ];
                    a += (ga << 25 | ga >>> 39);
                    b += (gb << 44 | gb >>> 20);
                    c += (gc << 37 | gc >>> 27);
        ...
        public long hash64(final long[] data) {
            ...
            long gd = a;
            switch(len & 3) {
                case 0x3: gc ^= data[i + 0x2];
                case 0x2: gb ^= data[i + 0x1];
                case 0x1: ga ^= data[i      ];
                    a += (ga << 25 | ga >>> 39);
                    b += (gb << 44 | gb >>> 20);
                    c += (gc << 37 | gc >>> 27);
        ...
        public long hash64(final double[] data) {
            ...
            long gd = a;
            switch(len & 3) {
                case 0x3: gc ^= doubleToRawLongBits(data[i + 0x2]);
                case 0x2: gb ^= doubleToRawLongBits(data[i + 0x1]);
                case 0x1: ga ^= doubleToRawLongBits(data[i      ]);
                    a += (ga << 25 | ga >>> 39);
                    b += (gb << 44 | gb >>> 20);
                    c += (gc << 37 | gc >>> 27);
                    d += (gd << 18 | gd >>> 46);
    ...
    public static final class Tritium {
        ...
        public Tritium(final CharSequence seed)
        {
            this(Water.hash64(seed));
        }

        public static final Tritium alpha = new Tritium("alpha"), beta = new Tritium("beta"), gamma = new Tritium("gamma"),
                delta = new Tritium("delta"), epsilon = new Tritium("epsilon"), zeta = new Tritium("zeta"),
                eta = new Tritium("eta"), theta = new Tritium("theta"), iota = new Tritium("iota"),
                kappa = new Tritium("kappa"), lambda = new Tritium("lambda"), mu = new Tritium("mu"),
                nu = new Tritium("nu"), xi = new Tritium("xi"), omicron = new Tritium("omicron"), pi = new Tritium("pi"),
                rho = new Tritium("rho"), sigma = new Tritium("sigma"), tau = new Tritium("tau"),
                upsilon = new Tritium("upsilon"), phi = new Tritium("phi"), chi = new Tritium("chi"), psi = new Tritium("psi"),
                omega = new Tritium("omega"),
                alpha_ = new Tritium("ALPHA"), beta_ = new Tritium("BETA"), gamma_ = new Tritium("GAMMA"),
                delta_ = new Tritium("DELTA"), epsilon_ = new Tritium("EPSILON"), zeta_ = new Tritium("ZETA"),
                eta_ = new Tritium("ETA"), theta_ = new Tritium("THETA"), iota_ = new Tritium("IOTA"),
                kappa_ = new Tritium("KAPPA"), lambda_ = new Tritium("LAMBDA"), mu_ = new Tritium("MU"),
                nu_ = new Tritium("NU"), xi_ = new Tritium("XI"), omicron_ = new Tritium("OMICRON"), pi_ = new Tritium("PI"),
                rho_ = new Tritium("RHO"), sigma_ = new Tritium("SIGMA"), tau_ = new Tritium("TAU"),
                upsilon_ = new Tritium("UPSILON"), phi_ = new Tritium("PHI"), chi_ = new Tritium("CHI"), psi_ = new Tritium("PSI"),
                omega_ = new Tritium("OMEGA"),
                baal = new Tritium("baal"), agares = new Tritium("agares"), vassago = new Tritium("vassago"), samigina = new Tritium("samigina"),
                marbas = new Tritium("marbas"), valefor = new Tritium("valefor"), amon = new Tritium("amon"), barbatos = new Tritium("barbatos"),
                paimon = new Tritium("paimon"), buer = new Tritium("buer"), gusion = new Tritium("gusion"), sitri = new Tritium("sitri"),
                beleth = new Tritium("beleth"), leraje = new Tritium("leraje"), eligos = new Tritium("eligos"), zepar = new Tritium("zepar"),
                botis = new Tritium("botis"), bathin = new Tritium("bathin"), sallos = new Tritium("sallos"), purson = new Tritium("purson"),
                marax = new Tritium("marax"), ipos = new Tritium("ipos"), aim = new Tritium("aim"), naberius = new Tritium("naberius"),
                glasya_labolas = new Tritium("glasya_labolas"), bune = new Tritium("bune"), ronove = new Tritium("ronove"), berith = new Tritium("berith"),
                astaroth = new Tritium("astaroth"), forneus = new Tritium("forneus"), foras = new Tritium("foras"), asmoday = new Tritium("asmoday"),
                gaap = new Tritium("gaap"), furfur = new Tritium("furfur"), marchosias = new Tritium("marchosias"), stolas = new Tritium("stolas"),
                phenex = new Tritium("phenex"), halphas = new Tritium("halphas"), malphas = new Tritium("malphas"), raum = new Tritium("raum"),
                focalor = new Tritium("focalor"), vepar = new Tritium("vepar"), sabnock = new Tritium("sabnock"), shax = new Tritium("shax"),
                vine = new Tritium("vine"), bifrons = new Tritium("bifrons"), vual = new Tritium("vual"), haagenti = new Tritium("haagenti"),
                crocell = new Tritium("crocell"), furcas = new Tritium("furcas"), balam = new Tritium("balam"), alloces = new Tritium("alloces"),
                caim = new Tritium("caim"), murmur = new Tritium("murmur"), orobas = new Tritium("orobas"), gremory = new Tritium("gremory"),
                ose = new Tritium("ose"), amy = new Tritium("amy"), orias = new Tritium("orias"), vapula = new Tritium("vapula"),
                zagan = new Tritium("zagan"), valac = new Tritium("valac"), andras = new Tritium("andras"), flauros = new Tritium("flauros"),
                andrealphus = new Tritium("andrealphus"), kimaris = new Tritium("kimaris"), amdusias = new Tritium("amdusias"), belial = new Tritium("belial"),
                decarabia = new Tritium("decarabia"), seere = new Tritium("seere"), dantalion = new Tritium("dantalion"), andromalius = new Tritium("andromalius"),
                baal_ = new Tritium("BAAL"), agares_ = new Tritium("AGARES"), vassago_ = new Tritium("VASSAGO"), samigina_ = new Tritium("SAMIGINA"),
                marbas_ = new Tritium("MARBAS"), valefor_ = new Tritium("VALEFOR"), amon_ = new Tritium("AMON"), barbatos_ = new Tritium("BARBATOS"),
                paimon_ = new Tritium("PAIMON"), buer_ = new Tritium("BUER"), gusion_ = new Tritium("GUSION"), sitri_ = new Tritium("SITRI"),
                beleth_ = new Tritium("BELETH"), leraje_ = new Tritium("LERAJE"), eligos_ = new Tritium("ELIGOS"), zepar_ = new Tritium("ZEPAR"),
                botis_ = new Tritium("BOTIS"), bathin_ = new Tritium("BATHIN"), sallos_ = new Tritium("SALLOS"), purson_ = new Tritium("PURSON"),
                marax_ = new Tritium("MARAX"), ipos_ = new Tritium("IPOS"), aim_ = new Tritium("AIM"), naberius_ = new Tritium("NABERIUS"),
                glasya_labolas_ = new Tritium("GLASYA_LABOLAS"), bune_ = new Tritium("BUNE"), ronove_ = new Tritium("RONOVE"), berith_ = new Tritium("BERITH"),
                astaroth_ = new Tritium("ASTAROTH"), forneus_ = new Tritium("FORNEUS"), foras_ = new Tritium("FORAS"), asmoday_ = new Tritium("ASMODAY"),
                gaap_ = new Tritium("GAAP"), furfur_ = new Tritium("FURFUR"), marchosias_ = new Tritium("MARCHOSIAS"), stolas_ = new Tritium("STOLAS"),
                phenex_ = new Tritium("PHENEX"), halphas_ = new Tritium("HALPHAS"), malphas_ = new Tritium("MALPHAS"), raum_ = new Tritium("RAUM"),
                focalor_ = new Tritium("FOCALOR"), vepar_ = new Tritium("VEPAR"), sabnock_ = new Tritium("SABNOCK"), shax_ = new Tritium("SHAX"),
                vine_ = new Tritium("VINE"), bifrons_ = new Tritium("BIFRONS"), vual_ = new Tritium("VUAL"), haagenti_ = new Tritium("HAAGENTI"),
                crocell_ = new Tritium("CROCELL"), furcas_ = new Tritium("FURCAS"), balam_ = new Tritium("BALAM"), alloces_ = new Tritium("ALLOCES"),
                caim_ = new Tritium("CAIM"), murmur_ = new Tritium("MURMUR"), orobas_ = new Tritium("OROBAS"), gremory_ = new Tritium("GREMORY"),
                ose_ = new Tritium("OSE"), amy_ = new Tritium("AMY"), orias_ = new Tritium("ORIAS"), vapula_ = new Tritium("VAPULA"),
                zagan_ = new Tritium("ZAGAN"), valac_ = new Tritium("VALAC"), andras_ = new Tritium("ANDRAS"), flauros_ = new Tritium("FLAUROS"),
                andrealphus_ = new Tritium("ANDREALPHUS"), kimaris_ = new Tritium("KIMARIS"), amdusias_ = new Tritium("AMDUSIAS"), belial_ = new Tritium("BELIAL"),
                decarabia_ = new Tritium("DECARABIA"), seere_ = new Tritium("SEERE"), dantalion_ = new Tritium("DANTALION"), andromalius_ = new Tritium("ANDROMALIUS")
                ;
        /**
         * Has a length of 192, which may be relevant if automatically choosing a predefined hash functor.
         */
        public static final Tritium[] predefined = new Tritium[]{alpha, beta, gamma, delta, epsilon, zeta, eta, theta, iota,
                kappa, lambda, mu, nu, xi, omicron, pi, rho, sigma, tau, upsilon, phi, chi, psi, omega,
                alpha_, beta_, gamma_, delta_, epsilon_, zeta_, eta_, theta_, iota_,
                kappa_, lambda_, mu_, nu_, xi_, omicron_, pi_, rho_, sigma_, tau_, upsilon_, phi_, chi_, psi_, omega_,
                baal, agares, vassago, samigina, marbas, valefor, amon, barbatos,
    ...
    public static final class Ax {
        ...
        public static final Ax alpha = new Ax("alpha"), beta = new Ax("beta"), gamma = new Ax("gamma"),
                delta = new Ax("delta"), epsilon = new Ax("epsilon"), zeta = new Ax("zeta"),
                eta = new Ax("eta"), theta = new Ax("theta"), iota = new Ax("iota"),
                kappa = new Ax("kappa"), lambda = new Ax("lambda"), mu = new Ax("mu"),
                nu = new Ax("nu"), xi = new Ax("xi"), omicron = new Ax("omicron"), pi = new Ax("pi"),
                rho = new Ax("rho"), sigma = new Ax("sigma"), tau = new Ax("tau"),
                upsilon = new Ax("upsilon"), phi = new Ax("phi"), chi = new Ax("chi"), psi = new Ax("psi"),
                omega = new Ax("omega"),
                alpha_ = new Ax("ALPHA"), beta_ = new Ax("BETA"), gamma_ = new Ax("GAMMA"),
                delta_ = new Ax("DELTA"), epsilon_ = new Ax("EPSILON"), zeta_ = new Ax("ZETA"),
                eta_ = new Ax("ETA"), theta_ = new Ax("THETA"), iota_ = new Ax("IOTA"),
                kappa_ = new Ax("KAPPA"), lambda_ = new Ax("LAMBDA"), mu_ = new Ax("MU"),
                nu_ = new Ax("NU"), xi_ = new Ax("XI"), omicron_ = new Ax("OMICRON"), pi_ = new Ax("PI"),
                rho_ = new Ax("RHO"), sigma_ = new Ax("SIGMA"), tau_ = new Ax("TAU"),
                upsilon_ = new Ax("UPSILON"), phi_ = new Ax("PHI"), chi_ = new Ax("CHI"), psi_ = new Ax("PSI"),
                omega_ = new Ax("OMEGA"),
                baal = new Ax("baal"), agares = new Ax("agares"), vassago = new Ax("vassago"), samigina = new Ax("samigina"),
                marbas = new Ax("marbas"), valefor = new Ax("valefor"), amon = new Ax("amon"), barbatos = new Ax("barbatos"),
                paimon = new Ax("paimon"), buer = new Ax("buer"), gusion = new Ax("gusion"), sitri = new Ax("sitri"),
                beleth = new Ax("beleth"), leraje = new Ax("leraje"), eligos = new Ax("eligos"), zepar = new Ax("zepar"),
                botis = new Ax("botis"), bathin = new Ax("bathin"), sallos = new Ax("sallos"), purson = new Ax("purson"),
                marax = new Ax("marax"), ipos = new Ax("ipos"), aim = new Ax("aim"), naberius = new Ax("naberius"),
                glasya_labolas = new Ax("glasya_labolas"), bune = new Ax("bune"), ronove = new Ax("ronove"), berith = new Ax("berith"),
                astaroth = new Ax("astaroth"), forneus = new Ax("forneus"), foras = new Ax("foras"), asmoday = new Ax("asmoday"),
                gaap = new Ax("gaap"), furfur = new Ax("furfur"), marchosias = new Ax("marchosias"), stolas = new Ax("stolas"),
                phenex = new Ax("phenex"), halphas = new Ax("halphas"), malphas = new Ax("malphas"), raum = new Ax("raum"),
                focalor = new Ax("focalor"), vepar = new Ax("vepar"), sabnock = new Ax("sabnock"), shax = new Ax("shax"),
                vine = new Ax("vine"), bifrons = new Ax("bifrons"), vual = new Ax("vual"), haagenti = new Ax("haagenti"),
                crocell = new Ax("crocell"), furcas = new Ax("furcas"), balam = new Ax("balam"), alloces = new Ax("alloces"),
                caim = new Ax("caim"), murmur = new Ax("murmur"), orobas = new Ax("orobas"), gremory = new Ax("gremory"),
                ose = new Ax("ose"), amy = new Ax("amy"), orias = new Ax("orias"), vapula = new Ax("vapula"),
                zagan = new Ax("zagan"), valac = new Ax("valac"), andras = new Ax("andras"), flauros = new Ax("flauros"),
                andrealphus = new Ax("andrealphus"), kimaris = new Ax("kimaris"), amdusias = new Ax("amdusias"), belial = new Ax("belial"),
                decarabia = new Ax("decarabia"), seere = new Ax("seere"), dantalion = new Ax("dantalion"), andromalius = new Ax("andromalius"),
                baal_ = new Ax("BAAL"), agares_ = new Ax("AGARES"), vassago_ = new Ax("VASSAGO"), samigina_ = new Ax("SAMIGINA"),
                marbas_ = new Ax("MARBAS"), valefor_ = new Ax("VALEFOR"), amon_ = new Ax("AMON"), barbatos_ = new Ax("BARBATOS"),
                paimon_ = new Ax("PAIMON"), buer_ = new Ax("BUER"), gusion_ = new Ax("GUSION"), sitri_ = new Ax("SITRI"),
                beleth_ = new Ax("BELETH"), leraje_ = new Ax("LERAJE"), eligos_ = new Ax("ELIGOS"), zepar_ = new Ax("ZEPAR"),
                botis_ = new Ax("BOTIS"), bathin_ = new Ax("BATHIN"), sallos_ = new Ax("SALLOS"), purson_ = new Ax("PURSON"),
                marax_ = new Ax("MARAX"), ipos_ = new Ax("IPOS"), aim_ = new Ax("AIM"), naberius_ = new Ax("NABERIUS"),
                glasya_labolas_ = new Ax("GLASYA_LABOLAS"), bune_ = new Ax("BUNE"), ronove_ = new Ax("RONOVE"), berith_ = new Ax("BERITH"),
                astaroth_ = new Ax("ASTAROTH"), forneus_ = new Ax("FORNEUS"), foras_ = new Ax("FORAS"), asmoday_ = new Ax("ASMODAY"),
                gaap_ = new Ax("GAAP"), furfur_ = new Ax("FURFUR"), marchosias_ = new Ax("MARCHOSIAS"), stolas_ = new Ax("STOLAS"),
                phenex_ = new Ax("PHENEX"), halphas_ = new Ax("HALPHAS"), malphas_ = new Ax("MALPHAS"), raum_ = new Ax("RAUM"),
                focalor_ = new Ax("FOCALOR"), vepar_ = new Ax("VEPAR"), sabnock_ = new Ax("SABNOCK"), shax_ = new Ax("SHAX"),
                vine_ = new Ax("VINE"), bifrons_ = new Ax("BIFRONS"), vual_ = new Ax("VUAL"), haagenti_ = new Ax("HAAGENTI"),
                crocell_ = new Ax("CROCELL"), furcas_ = new Ax("FURCAS"), balam_ = new Ax("BALAM"), alloces_ = new Ax("ALLOCES"),
                caim_ = new Ax("CAIM"), murmur_ = new Ax("MURMUR"), orobas_ = new Ax("OROBAS"), gremory_ = new Ax("GREMORY"),
                ose_ = new Ax("OSE"), amy_ = new Ax("AMY"), orias_ = new Ax("ORIAS"), vapula_ = new Ax("VAPULA"),
                zagan_ = new Ax("ZAGAN"), valac_ = new Ax("VALAC"), andras_ = new Ax("ANDRAS"), flauros_ = new Ax("FLAUROS"),
                andrealphus_ = new Ax("ANDREALPHUS"), kimaris_ = new Ax("KIMARIS"), amdusias_ = new Ax("AMDUSIAS"), belial_ = new Ax("BELIAL"),
                decarabia_ = new Ax("DECARABIA"), seere_ = new Ax("SEERE"), dantalion_ = new Ax("DANTALION"), andromalius_ = new Ax("ANDROMALIUS")
                ;
        /**
         * Has a length of 192, which may be relevant if automatically choosing a predefined hash functor.
         */
        public static final Ax[] predefined = new Ax[]{alpha, beta, gamma, delta, epsilon, zeta, eta, theta, iota,
                kappa, lambda, mu, nu, xi, omicron, pi, rho, sigma, tau, upsilon, phi, chi, psi, omega,
                alpha_, beta_, gamma_, delta_, epsilon_, zeta_, eta_, theta_, iota_,
                kappa_, lambda_, mu_, nu_, xi_, omicron_, pi_, rho_, sigma_, tau_, upsilon_, phi_, chi_, psi_, omega_,
                baal, agares, vassago, samigina, marbas, valefor, amon, barbatos,
