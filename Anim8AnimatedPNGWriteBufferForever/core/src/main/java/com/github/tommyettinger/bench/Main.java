 ...
 * <pre>
 *     // SUB filter, market
 *     Took 99563 ms to write 32 APNGs
 *     // SUB filter, alpha
 *     Took 19497 ms to write 32 APNGs
 * </pre>
 */
...
//    private static final String INPUT_EXTENSION = ".png";
    ...
    public void render() {
        ...
        apng.write(Gdx.files.local("tmp/imagesClean/" + name + "/AnimatedPNG-" + name + ".png"), pixmaps, fps + (numWritten & 7));
        numWritten++;
    }
}
