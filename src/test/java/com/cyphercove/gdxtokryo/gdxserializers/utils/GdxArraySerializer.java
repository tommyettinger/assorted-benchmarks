...
public class GdxArraySerializer extends Serializer<Array<?>> {
    ...
    protected Array<?> create (boolean ordered, int capacity, Class type) {
        return (new Array(ordered, capacity, type));
    }
    ...
    public Array<?> read(Kryo kryo, Input input, Class<? extends Array<?>> type) {
        ...
        Array array = create(ordered, length, cls);
    ...
    public Array<?> copy (Kryo kryo, Array original) {
        ...
        Array<?> copy = create(original.ordered, original.size, cls);
        kryo.reference(copy);
