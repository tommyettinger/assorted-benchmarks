...
/**
 * Note that LinkedHashMap and other JDK collections have access to a second non-public hashCode for each String, and no other
 * code has this advantage (but it only applies to String keys).
 * At load factor 0.5f:
 * When run with JVM:
 * {@code OpenJDK 64-Bit Server VM (AdoptOpenJDK)(build 25.212-b03, mixed mode)} (HotSpot)
 * This gets these results (higher is better):
 * <br>
 * LinkedHashMap_String_String_Bench score: 18682952.000000 (18.68M 1674.3%)
 *                               uncertainty:   1.7%
 * <br>
 * When run with JVM:
 ...
 * 
 */
public final class LinkedHashMap_String_String_Bench extends MiniBench {
	@Override
	...
	protected long doBatch(long numLoops, int numIterationsPerLoop) throws InterruptedException {
		...
		for (long i = 0; i < numLoops; i++) {
			final LinkedHashMap<String, String> coll = new LinkedHashMap<>(16, 0.5f);
