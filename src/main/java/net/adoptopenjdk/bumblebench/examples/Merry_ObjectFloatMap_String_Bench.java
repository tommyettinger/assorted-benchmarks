...
import com.github.tommyettinger.merry.ObjectFloatMap;
 ...
 * <br>
 * Merry_ObjectFloatMap_String_Bench score: 24253054.000000 (24.25M 1700.4%)
 *                              uncertainty:   6.5%
 * <br>
 * When run with JVM:
 ...
 * 
 */
public final class Merry_ObjectFloatMap_String_Bench extends MiniBench {
	@Override
	...
	protected long doBatch(long numLoops, int numIterationsPerLoop) throws InterruptedException {
		...
		for (long i = 0; i < numLoops; i++) {
			final ObjectFloatMap<String> coll = new ObjectFloatMap<>(16, 0.5f);
