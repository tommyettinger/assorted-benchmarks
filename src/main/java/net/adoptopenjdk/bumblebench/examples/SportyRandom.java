...
/**
 * 256 bits of state. Period is 2 to the 64.
 * There are 2 to the 192 possible streams.
 * Immediately-adjacent values for streamB, streamC, and/or streamD will produce correlated streams.
 * <br>
