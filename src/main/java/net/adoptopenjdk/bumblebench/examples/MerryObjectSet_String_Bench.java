 ...
 * <br>
 * MerryObjectSet_String_Bench score: 23828476.000000 (23.83M 1698.6%)
 *                         uncertainty:   0.5%
 * <br>
 * When run with JVM:
 ...
 * 
 */
public final class MerryObjectSet_String_Bench extends MiniBench {
	@Override
	...
	protected long doBatch(long numLoops, int numIterationsPerLoop) throws InterruptedException {
		final MerryObjectSet<String> coll = new MerryObjectSet<>(16, 0.5f);
		String book = "";
		try {
