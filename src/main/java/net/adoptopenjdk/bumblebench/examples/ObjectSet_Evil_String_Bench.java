 ...
 * <br>
 * Near-immediate java.lang.OutOfMemoryError, crashing the benchmark.
 * <br>
 * When run with JVM:
 ...
 * <br>
 * (It will be a different result, but only because it will dump heap.)
 */
public final class ObjectSet_Evil_String_Bench extends MiniBench {
	@Override
