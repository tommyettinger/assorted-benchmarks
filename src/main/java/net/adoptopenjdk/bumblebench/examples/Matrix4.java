 ...
 * </pre>
 * <br>
 * This code was taken from Arc, which mostly reused libGDX code but replaced some native methods with pure-Java ones.
 * 
...
public class Matrix4{
     ...
     */
    public static Vector3 prj(Vector3 v, Matrix4 matrix){
     ...
     * @return This vector for chaining
     */
    public static Vector3 rot(Vector3 v, Matrix4 matrix){
        final float[] lmat = matrix.val;
     ...
     * rotation, does not work for scaling. For those, use {@link #rot(Vector3, Matrix4)} with {@link Matrix4#inv()}.
     * @param matrix The transformation matrix
     * @return The vector for chaining
     */
    public static Vector3 unrotate(Vector3 v, Matrix4 matrix){
        final float[] lmat = matrix.val;
     ...
     * @return The vector for chaining
     */
    public static Vector3 untransform(Vector3 v, Matrix4 matrix){
        final float[] lmat = matrix.val;
