 ...
 * <br>
 * CuckooObjectSet_String_Bench score: 25084428.000000 (25.08M 1703.8%)
 *                          uncertainty:   0.8%
 * <br>
 * When run with JVM:
 ...
 * 
 */
public final class CuckooObjectSet_String_Bench extends MiniBench {
	@Override
	...
	protected long doBatch(long numLoops, int numIterationsPerLoop) throws InterruptedException {
		final CuckooObjectSet<String> coll = new CuckooObjectSet<>(16, 0.5f);
		String book = "";
		try {
