 ...
 * <br>
 * FloatSortRevAltBench score: 377.049408 (377.0 593.2%)
 *                  uncertainty:   0.2%
 * <br>
 ...
 *
 */
public final class FloatSortRevAltBench extends MicroBench {
	...
	protected long doBatch(long numIterations) throws InterruptedException {
		...
		for (long i = 0; i < numIterations; i++) {
			...
			startTimer();
			list.sort(FloatComparators.OPPOSITE_ALTERNATE_COMPARATOR);
			sum += list.peek();
		}
