 ...
 * <br>
 * FloatSortBench score: 391.384552 (391.4 597.0%)
 *            uncertainty:   0.1%
 * <br>
 * With Java 14, OpenJ9, same hardware:
 * <br>
 * FloatSortBench score: 262.725983 (262.7 557.1%)
 *            uncertainty:   0.2%
 */
public final class FloatSortBench extends MicroBench {
	...
	protected long doBatch(long numIterations) throws InterruptedException {
		...
		for (long i = 0; i < numIterations; i++) {
			...
			startTimer();
			list.sort(FloatComparators.NATURAL_COMPARATOR);
			sum += list.peek();
		}
