 ...
 * <p>
 * This implementation uses quadratic probing with the backward shift algorithm for removal.
 * It tries different hashes from a simple family, with the hash changing on resize.
 * Quadratic probing continues to work even when all hashCodes collide; it just works more slowly in that case.
 *
 * @author Nathan Sweet
 * @author Tommy Ettinger
 */
public class ObjectObjectQuadMap<K, V> implements Map<K, V>, Iterable<Map.Entry<K, V>> {
...
//		return item.hashCode() & mask;
	 ...
	 * <br>
	 * Note that {@link #putAll(ObjectObjectQuadMap)} is more specific and can be
	 ...
	 * does not permit nested iteration. Iterate over {@link Entries#Entries(ObjectObjectQuadMap)} if you
	 * need nested or multithreaded iteration. You can remove an Entry from this ObjectObjectQuadMap
	 * using this Iterator.
	 *
	 ...
	 * {@link #ObjectObjectQuadMap(Object[], Object[])}, which takes all keys and then all values.
