...
/**
 * Created by Tommy Ettinger on 3/23/2024.
 */
public class ClassObjectMap<V> extends IdentityObjectMap<Class<?>, V> {
	/**
	 ...
	 */
	public ClassObjectMap(int initialCapacity) {
	 ...
	 * @param loadFactor
	 */
	public ClassObjectMap(int initialCapacity, float loadFactor) {
	 ...
	 * @param map
	 */
	public ClassObjectMap(ObjectObjectMap<? extends Class<?>, ? extends V> map) {
		super(map);
	}
	 ...
	 * @param map
	 */
	public ClassObjectMap(Map<? extends Class<?>, ? extends V> map) {
		super(map);
	}
	 ...
	 */
	public ClassObjectMap(Class[] keys, V[] values) {
		super(keys, values);
	}
	 ...
	 */
	public ClassObjectMap(Collection<? extends Class<?>> keys, Collection<? extends V> values) {
		super(keys, values);
	}
	...
	protected int place(Object item) {
		return ((Class<?>)item).getName().hashCode() & mask;
	}
