 ...
 */
public class OrderedMapMulXor<K, V> extends ObjectObjectOrderedMap<K, V> {
	public OrderedMapMulXor() {
		super();
	}

	public OrderedMapMulXor(int initialCapacity) {
		super(initialCapacity);
	}

	public OrderedMapMulXor(int initialCapacity, float loadFactor) {
		super(initialCapacity, loadFactor);
	}

	public OrderedMapMulXor(ObjectObjectOrderedMap<? extends K, ? extends V> map) {
		super(map);
	}
	 ...
	 * @param map
	 */
	public OrderedMapMulXor(Map<? extends K, ? extends V> map) {
		super(map);
	}
