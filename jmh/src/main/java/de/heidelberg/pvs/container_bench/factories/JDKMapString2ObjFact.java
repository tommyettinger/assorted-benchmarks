...
public enum JDKMapString2ObjFact {
...
//JDK_O2O_HASH,JDKGDXDS_HASH,JDKGDXDSSTRING_HASH
//JDK_O2O_LINKEDHASH,JDKGDXDS_INDEXED,JDKGDXDSSTRING_INDEXED
	...
	private JDKMapString2ObjFact(Supplier<Map<String, Object>> maker) {
		this(maker, Integer.MAX_VALUE);
	}

	private JDKMapString2ObjFact(Supplier<Map<String, Object>> maker, int maxsize) {
		this.maker = maker;
