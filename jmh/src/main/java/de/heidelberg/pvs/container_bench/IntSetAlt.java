 ...
 */
public class IntSetAlt implements PrimitiveSet.SetOfInt {
	 ...
	 */
	public IntSetAlt (int initialCapacity) {
	 ...
	 */
	public IntSetAlt (int initialCapacity, float loadFactor) {
	 ...
	 */
	public IntSetAlt (IntIterator coll) {
		this();
		addAll(coll);
	}
	 ...
	 */
	public IntSetAlt (IntSetAlt set) {
	 ...
	 */
	public IntSetAlt (PrimitiveCollection.OfInt coll) {
		this(coll.size());
		addAll(coll);
	}
	 ...
	 */
	public IntSetAlt (int[] array, int offset, int length) {
		this(length);
	...
	protected int place (int item) {
		item = BitConversion.imul(item, hashMultiplier);
		return (item ^ item >>> 16) & mask;
	}
	...
	public boolean addAll (IntSetAlt set) {
...
//						resize(keyTable.length >>> 1);
	...
	public static class IntSetIterator implements IntIterator {
		 ...
		 */
		protected final IntSetAlt set;

		public IntSetIterator (IntSetAlt set) {
			this.set = set;
			reset();
		}
	...
	public static IntSetAlt with (int item) {
		IntSetAlt set = new IntSetAlt(1);
		set.add(item);
		return set;
	}

	public static IntSetAlt with (int... array) {
		return new IntSetAlt(array);
	}
}
