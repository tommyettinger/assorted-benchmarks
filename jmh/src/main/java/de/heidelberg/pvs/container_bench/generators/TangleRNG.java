 ...
 */
public final class TangleRNG implements Serializable {
    ...
    /**
     * @param bound exclusive upper bound, must be non-negative
     * @return an int between 0, inclusive, and bound, exclusive
     */
    public final int nextInt(final int bound) {
        final long s = (stateA += 0xC6BC279692B5C323L);
        final long z = (s ^ s >>> 31) * (stateB += 0x9E3779B97F4A7C16L);
        return (int) ((bound * ((z ^ z >>> 26) & 0xFFFFFFFFL)) >>> 32);
    }
    ...
    public String toString() {
        return "TangleRNG with stateA 0x" + Long.toHexString(stateA) + "L and stateB 0x" + Long.toHexString(stateB) + 'L';
    }
