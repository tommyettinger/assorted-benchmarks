...
public class StringObjectMap<V> extends ObjectObjectMap<String, V> {
    /**
     ...
     */
    public StringObjectMap(ObjectObjectMap<? extends String, ? extends V> map) {
        super(map);
    }
     ...
     */
    public StringObjectMap(Map<? extends String, ? extends V> map) {
        super(map);
    }
     ...
     */
    public StringObjectMap(String[] keys, V[] values) {
        super(keys, values);
    }
     ...
     */
    public StringObjectMap(Collection<? extends String> keys, Collection<? extends V> values) {
        super(keys, values);
    }
